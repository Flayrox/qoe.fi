...
# === Emails & Newsletters (Stalwart local / Hostinger SMTP / Resend) ===
EMAIL_PROVIDER=smtp
SMTP_HOST=127.0.0.1
SMTP_PORT=25
SMTP_USER=
SMTP_PASS=
SMTP_SECURE=false
EMAIL_FROM=auth@qoe.fi
NEWSLETTER_FROM=newsletter@qoe.fi
NEWSLETTER_UNSUB_SECRET=change_me_super_secret_unsub_key_prod
RESEND_API_KEY=re_...
```
