            ...
            <button
              ...
              className={cn(
                ...
                isActive
                  ...
                  : 'bg-muted/50 border-border/40 opacity-70 hover:opacity-100 hover:bg-muted/40'
              )}
            >
              <div className="text-2xl md:text-3xl font-bold tracking-tight text-foreground group-hover:scale-[1.01] transition-transform duration-300">
              ...
              <div className="mt-3 flex items-center justify-between w-full">
                ...
                <div
                  className={cn(
                    ...
                    isActive
                      ? 'scale-120'
                      : 'scale-50 opacity-40 group-hover:scale-75 group-hover:opacity-100'
                  )}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {isMounted ? (
              ...
              <div className="w-full h-full bg-muted/50 animate-pulse rounded-3xl" />
            )}
          </motion.div>
        </AnimatePresence>
      </div>
