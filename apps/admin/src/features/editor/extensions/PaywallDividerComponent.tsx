  ...
  return (
    <NodeViewWrapper className="paywall-divider-component relative py-8 my-8 select-none">
      ...
      <div className="relative flex justify-center">
        <span className="bg-foreground px-4 py-2 rounded-full border border-highlight/50 text-highlight text-sm font-bold tracking-widest uppercase flex items-center gap-2 shadow-lg shadow-highlight/10">
