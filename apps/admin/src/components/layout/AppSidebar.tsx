...
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@qoe/ui/ui/tooltip';
          ...
          >
            <div className="flex flex-col h-full w-full py-5">
              ...
              <div className="space-y-6">
                ...
                {/* Navigation */}
                <nav className="space-y-0.5 px-2" onMouseLeave={() => setHoveredIndex(null)}>
                  {navLinks.map((link) => {
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  user?.role === 'creator'
                    ? 'ring-1 ring-[var(--qoe-vermillion)]/25 ring-offset-1'
                    : ''
                )}
              >
                {user?.logoUrl ? (
