    ...
    <>
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse at center, rgba(238,75,43,0.12) 0%, rgba(238,75,43,0.06) 35%, rgba(238,75,43,0.02) 60%, transparent 80%)',
            filter: 'blur(60px)',
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse at center, rgba(255,180,140,0.15) 0%, rgba(255,200,170,0.08) 40%, transparent 70%)',
            filter: 'blur(80px)',
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse at center, rgba(255,230,215,0.2) 0%, transparent 60%)',
            filter: 'blur(100px)',
          }}
        />
      ...
      >
        ...
        {giantTitle && (
          <div
            className={cn(
              'sticky h-0 z-10 pointer-events-none select-none',
              isTimeline ? 'top-0' : 'top-[48px]'
            )}
          >
            <div className="absolute left-2 top-1">
              <span className="font-sans text-5xl font-extrabold text-[var(--qoe-vermillion)] tracking-tighter">
                {giantTitle}
                <span className="text-[var(--text-primary)]">{giantTitleSuffix}</span>
              </span>
            </div>
          </div>
        )}
