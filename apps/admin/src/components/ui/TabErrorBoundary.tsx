...
function TabErrorFallback({
  ...
  return (
    <div className="bg-card border border-border/50 rounded-xl p-8 shadow-xs flex flex-col items-center justify-center text-center gap-4 py-16 animate-fadeIn">
      <div className="p-3 bg-destructive/10 text-[#EE4B2B] rounded-full border border-destructive">
      ...
      <div className="flex gap-2 items-center mt-2">
        ...
        {onClose && (
          <button
            onClick={handleClose}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-foreground text-background text-xs font-semibold hover:opacity-90 cursor-pointer transition-colors"
          >
