-- +goose Up
-- =====================================================================
-- Migration squashée n°1 : schéma complet (source sqlc).
-- Converti depuis l'historique Prisma (packages/db/prisma/migrations)
-- — les 29 migrations dev ont été squassées en un seul init identique à
-- apps/api/sql/schema/schema.sql (la source de vérité sqlc).
-- =====================================================================
...
-- +goose Down
-- Dev reset uniquement : tout détruire (le Up est idempotent et recrée tout).
