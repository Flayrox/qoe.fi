...
CREATE TABLE "Highlight" (
    ...
    "canonicalStart" INTEGER,
    "canonicalEnd" INTEGER,
    "contentSha" TEXT,
...
-- CreateIndex
CREATE INDEX "legal_document_active_order_idx" ON "legal_document" ("is_active", "sort_order");
...
-- CreateIndex
CREATE UNIQUE INDEX "legal_document_version_one_published_idx"
...
-- CreateIndex
CREATE INDEX "legal_acceptance_user_idx" ON "legal_acceptance" ("user_id", "accepted_at" DESC);
