...
const sizeClasses: Record<AvatarSize, { container: string; text: string; badge: string }> = {
  xs: { container: "w-5 h-5 rounded-full", text: "text-[9px]", badge: "text-[8px] -bottom-0.5 -right-0.5" },
  sm: { container: "w-7 h-7 rounded-full", text: "text-[10px]", badge: "text-[9px] -bottom-0.5 -right-0.5" },
  md: { container: "w-9 h-9 rounded-full", text: "text-xs", badge: "text-[10px] -bottom-0.5 -right-0.5" },
  lg: { container: "w-12 h-12 rounded-full", text: "text-sm", badge: "text-xs -bottom-1 -right-1" },
  xl: { container: "w-20 h-20 rounded-full", text: "text-2xl", badge: "text-sm -bottom-1 -right-1" },
  "2xl": { container: "w-28 h-28 rounded-full", text: "text-4xl", badge: "text-base -bottom-1 -right-1" },
}
