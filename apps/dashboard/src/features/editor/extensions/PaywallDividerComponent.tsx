  ...
  return (
    <NodeViewWrapper className="paywall-divider-component relative py-8 my-8 select-none">
      ...
      <div className="relative flex justify-center">
        <span className="bg-card px-4 py-2 rounded-full border border-amber-500/50 text-amber-500 text-xs font-bold tracking-wider uppercase flex items-center gap-2 shadow-lg shadow-amber-500/10">
