...
import { Laptop, Smartphone, Tablet, Globe, Monitor } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Répartition technique et géographique de vos lecteurs
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="absolute bottom-0 left-3 right-3 h-[2px] bg-transparent">
                  <div
                    className="h-full bg-primary/40 rounded-full transition-all duration-300 group-hover:bg-primary/70"
