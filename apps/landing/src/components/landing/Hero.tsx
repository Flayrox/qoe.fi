    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          >
            <path
              d="M1 1L1 21L6.5 15.5L9.5 23L12 22L9 14.5H16.5L1 1Z"
              fill="white"
              stroke="#000000"
              strokeWidth="1.5"
      ...
      <div className="w-full rounded-[36px] bg-[#EE4B2B] flex flex-col md:flex-row overflow-hidden shadow-2xl md:h-[680px] p-2 md:p-3 gap-2 md:gap-3">
        ...
        >
          <div
            className={cn(
              ...
              active === 'writer' ? 'opacity-100' : 'opacity-0 pointer-events-none'
            )}
          >
            <div className="w-full h-full bg-white rounded-[24px] flex flex-col overflow-hidden">
              ...
              <div className="flex-1 overflow-hidden px-8 md:px-14 py-8 flex flex-col gap-4">
                ...
                <h1 className="text-2xl md:text-[2rem] font-bold text-foreground leading-tight tracking-tight mt-2">
                  {editorTitle}
                </h1>
                <p className="text-sm md:text-base text-muted-foreground leading-relaxed min-h-[6rem] max-w-2xl whitespace-pre-line">
                  {typedBody}
          ...
          <div
            className={cn(
              'absolute inset-0 flex flex-col justify-end p-8 transition-opacity duration-400',
              active === 'writer' ? 'opacity-0 pointer-events-none' : 'opacity-100'
            )}
          >
        ...
        >
          <div
            className={cn(
              'absolute inset-0 transition-opacity duration-400',
              active === 'reader' ? 'opacity-100' : 'opacity-0 pointer-events-none'
            )}
          >
            <div className="w-full h-full bg-white rounded-[24px] flex flex-col overflow-hidden">
          ...
          <div
            className={cn(
              'absolute inset-0 flex flex-col justify-end p-6 transition-opacity duration-400',
...
export const Hero = ({ config }: HeroProps) => {
  ...
  // Main close handler — fly-to-logo genie effect
