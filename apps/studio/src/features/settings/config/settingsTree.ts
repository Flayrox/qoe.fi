...
export const settingsTree: SettingsNode = {
  ...
  children: [
    ...
    {
      id: 'emails',
      titleKey: 'dashboard.settings.emails_title',
      label: () => t`Emails transactionnels`,
      path: '#emails',
      children: [
        {
          id: 'emails-customization',
          titleKey: 'dashboard.settings.emails_customization',
          label: () => t`Expéditeur, couleurs & sujets`,
          hash: '#emails',
          keywordsKey: [
            'email',
            'emails',
