      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          <h3 className="text-[17px] font-semibold tracking-tight text-foreground">
            Publications & Pages lues
          </h3>
          <p className="text-xs text-muted-foreground mt-0.5">
            Cliquez sur un article pour analyser ses métriques dédiées
          </p>
        </div>
        <span className="text-xs text-muted-foreground font-medium">{topPages.length} écrits</span>
      </div>
              ...
              >
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-3 min-w-0 pr-4">
                    ...
                    <span
                      className="font-medium text-foreground text-sm truncate group-hover:text-primary transition-colors"
                      title={displayTitle}
                    >
                      {displayTitle}
                    </span>
