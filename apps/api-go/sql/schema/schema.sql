...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('LIKE', 'REPOST', 'REPLY', 'COMMENT', 'MENTION', 'FOLLOW', 'MEDIA_INVITE', 'MEDIA_MEMBER_JOINED', 'MEDIA_ARTICLE_PUBLISHED', 'MEDIA_ARTICLE_SUBMITTED', 'MEDIA_MENTION');
