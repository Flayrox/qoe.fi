...
async function main() {
  ...
  const defaultConfigs = [
    ...
    },
    {
      ...
      value: "Un portefeuille virtuel intégré permettant de soutenir vos auteurs préférés via WalletTransaction sans intermédiaire.",
      description: "Description de la fonctionnalité de micro-portefeuille dans la grille Bento"
    },
    {
      key: "feature_vector_desc",
      value: "Grâce à pgvector, notre IA brise votre bulle idéologique en injectant des perspectives radicalement différentes.",
      description: "Description de la fonctionnalité de sérendipité IA dans la grille Bento"
    },
    {
      key: "feature_monastic_desc",
      value: "Un carnet personnel numérique où vos Highlights deviennent la matière première de votre propre pensée.",
