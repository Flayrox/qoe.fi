...
export async function seedFullDatabaseAction() {
  try {
    ...
    async function createFullUser(data: {
      ...
      try {
        ...
        if (authRes.data?.user) {
          ...
          const existing = listRes.data?.users?.find((u: any) => u.email === data.email);
          if (existing) {
            userId = existing.id;
    ...
    const victor = await createFullUser({
      ...
      role: "creator",
      subdomain: "victor",
      logoUrl: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&auto=format&fit=crop&q=80",
      headerImageUrl: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1200&auto=format&fit=crop&q=80",
      isCertified: true,
      accentColor: "#c5a880",
    ...
    const simone = await createFullUser({
      ...
      role: "creator",
      subdomain: "simone",
      logoUrl: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&auto=format&fit=crop&q=80",
      headerImageUrl: "https://images.unsplash.com/photo-1507842217343-583bb7270b66?w=1200&auto=format&fit=crop&q=80",
      isCertified: true,
      accentColor: "#e07a5f",
    ...
    const marcus = await createFullUser({
      ...
      headerImageUrl: "https://images.unsplash.com/photo-1519681393784-d120267933ba?w=1200&auto=format&fit=crop&q=80",
      isCertified: true,
      accentColor: "#3d5a80",
    ...
    const camus = await createFullUser({
      ...
      role: "creator",
      subdomain: "camus",
      logoUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&auto=format&fit=crop&q=80",
      headerImageUrl: "https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=1200&auto=format&fit=crop&q=80",
      isCertified: true,
      accentColor: "#2b2d42",
    ...
    const ada = await createFullUser({
      ...
      headerImageUrl: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1200&auto=format&fit=crop&q=80",
      isCertified: true,
      accentColor: "#9b5de5",
    ...
    const fanon = await createFullUser({
      ...
      role: "creator",
      subdomain: "fanon",
      logoUrl: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&auto=format&fit=crop&q=80",
      headerImageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&auto=format&fit=crop&q=80",
      isCertified: true,
      accentColor: "#00bbf9",
    ...
    const arendt = await createFullUser({
      ...
      role: "creator",
      subdomain: "arendt",
      logoUrl: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&auto=format&fit=crop&q=80",
      headerImageUrl: "https://images.unsplash.com/photo-1457369804613-52c61a468e7d?w=1200&auto=format&fit=crop&q=80",
      isCertified: true,
      accentColor: "#f15bb5",
    ...
    const spinoza = await createFullUser({
      ...
      role: "creator",
      subdomain: "spinoza",
      logoUrl: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=400&auto=format&fit=crop&q=80",
      headerImageUrl: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=1200&auto=format&fit=crop&q=80",
      isCertified: true,
      accentColor: "#00f5d4",
    ...
    const readers = await Promise.all([
      createFullUser({ name: "Lucile Mercier", email: "lucile@qoe.fi", username: "lucile", role: "user", logoUrl: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&auto=format&fit=crop&q=80", walletBalanceCents: 15000 }),
      createFullUser({ name: "Alexandre Petit", email: "alex@qoe.fi", username: "alex", role: "user", logoUrl: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&auto=format&fit=crop&q=80", walletBalanceCents: 8000 }),
      createFullUser({ name: "Elena Rostova", email: "elena@qoe.fi", username: "elena", role: "user", logoUrl: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=400&auto=format&fit=crop&q=80", walletBalanceCents: 20000 }),
      createFullUser({ name: "Thomas Moreau", email: "thomas@qoe.fi", username: "thomas", role: "user", logoUrl: "https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?w=400&auto=format&fit=crop&q=80", walletBalanceCents: 5000 }),
      createFullUser({ name: "Clara Dupont", email: "clara@qoe.fi", username: "clara", role: "user", logoUrl: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400&auto=format&fit=crop&q=80", walletBalanceCents: 12000 }),
      createFullUser({ name: "Julien Vane", email: "julien@qoe.fi", username: "julien", role: "user", logoUrl: "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=400&auto=format&fit=crop&q=80", walletBalanceCents: 3000 }),
      createFullUser({ name: "Maya Lin", email: "maya@qoe.fi", username: "maya", role: "user", logoUrl: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&auto=format&fit=crop&q=80", walletBalanceCents: 18000 }),
      createFullUser({ name: "Gabriel Silva", email: "gabriel@qoe.fi", username: "gabriel", role: "user", logoUrl: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&auto=format&fit=crop&q=80", walletBalanceCents: 9000 }),
      createFullUser({ name: "Sophia Chen", email: "sophia@qoe.fi", username: "sophia", role: "user", logoUrl: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&auto=format&fit=crop&q=80", walletBalanceCents: 25000 }),
      createFullUser({ name: "Arthur Pendelton", email: "arthur@qoe.fi", username: "arthur", role: "user", logoUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&auto=format&fit=crop&q=80", walletBalanceCents: 10000 }),
    ]);
    ...
    for (const acc of allAccounts) {
      for (const cr of creators) {
        if (acc.id !== cr.id) {
          followPairs.push([acc.id, cr.id]);
        }
      }
    }

    for (const [rId, cId] of followPairs) {
      await prisma.follows.create({
        data: { readerId: rId, creatorId: cId },
      }).catch(() => {});
    }

    // 6. Recommandations entre créateurs (Substack style)
    const recommendationsData = [
      { recommenderId: victor.id, recommendedId: simone.id, description: "Une rigueur philosophique indispensable pour notre époque." },
      { recommenderId: simone.id, recommendedId: camus.id, description: "La plume la plus lucide sur la liberté et l'engagement." },
      { recommenderId: camus.id, recommendedId: fanon.id, description: "Une force intellectuelle majeure pour la libération de la conscience." },
      { recommenderId: marcus.id, recommendedId: spinoza.id, description: "Une sérénité et une logique parfaite dans le tumulte des idées." },
      { recommenderId: ada.id, recommendedId: spinoza.id, description: "Une harmonie entre les mathématiques de la nature et l'éthique." },
      { recommenderId: arendt.id, recommendedId: simone.id, description: "Un témoignage vibrant sur la condition humaine et la responsabilité." },
    ];
    ...
    const creatorCategories: Record<string, any[]> = {};
    for (const cr of creators) {
      // Tiers
      await prisma.tier.createMany({
        data: [
          { name: "Lecteur Libre", monthlyPriceCents: 0, creatorId: cr.id, description: "Accès aux écrits publics et aux réflexions hebdomadaires." },
          { name: "Cercle des Souverains", monthlyPriceCents: 799, yearlyPriceCents: 7990, creatorId: cr.id, description: "Accès aux essais exclusifs, réflexions privées et réunions monastiques." },
          { name: "Mécène Sanctuaire", monthlyPriceCents: 1999, yearlyPriceCents: 19990, creatorId: cr.id, description: "Soutien direct à la création indépendante, accès aux brouillons et mentions d'honneur." },
        ],
      });
      ...
      await prisma.navigationItem.createMany({
        data: [
          { label: "Accueil", url: "/", order: 1, userId: cr.id },
          { label: "Essais & Récits", url: "/category/essais", order: 2, userId: cr.id },
          { label: "À propos", url: "/about", order: 3, userId: cr.id },
        ],
      });
      ...
      await prisma.socialLink.createMany({
        data: [
          { platform: "x", url: `https://x.com/${cr.username}`, order: 1, userId: cr.id },
          { platform: "bluesky", url: `https://bsky.app/profile/${cr.username}.bsky.social`, order: 2, userId: cr.id },
        ],
      });

      // Categories
      const cat1 = await prisma.category.create({ data: { name: "Essais & Philosophie", slug: "essais", userId: cr.id } });
      const cat2 = await prisma.category.create({ data: { name: "Souveraineté & Liberté", slug: "souverainete", userId: cr.id } });
...
<p>L'expérience m'avait appris que toutes les choses qui arrivent fréquemment dans la vie ordinaire sont vaines et futiles. Je décidais enfin de chercher s'il existait un bien véritable.</p>`,
    ...
    for (const art of createdArticles) {
      ...
      const c1 = await prisma.articleComment.create({
        data: {
          ...
          content: "Une lecture d'une profondeur rare. Merci pour ce texte inspirant qui remet les idées à leur vraie place !",
          createdAt: c1Date,
        },
      });
      ...
      await prisma.articleComment.create({
        data: {
          ...
          parentId: c2.id,
          content: "Je partage totalement cette analyse sur la reconquête de notre souveraineté intellectuelle. Hâte de lire la suite !",
          createdAt: c3Date,
        },
      });
    }
    ...
    for (let i = 0; i < 35; i++) {
      ...
      const postDate = new Date(nowMs - (10 * MINUTE_MS + i * 3 * HOUR_MS + Math.floor(Math.random() * 20 * MINUTE_MS)));
      ...
      const post = await prisma.thought.create({
        data: {
          ...
          visibility: "public",
          isDraft: false,
          imageUrl: i % 5 === 0 ? "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&q=80" : null,
          createdAt: postDate,
          updatedAt: postDate,
        },
      });
    ...
    const pollThought = await prisma.thought.create({
      data: {
        content: "📊 Sondage du Sanctuaire : Combien d'heures par jour consacrez-vous à la lecture ininterrompue ?",
        authorId: marcus.id,
    ...
    return { success: false, error: error?.message || "Failed to seed full database" };
  }
}
