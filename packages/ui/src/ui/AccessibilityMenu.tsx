...
import { Type, Moon, Sun, Monitor, Type as TypeIcon } from "lucide-react"
...
export function AccessibilityMenu() {
  ...
  useEffect(() => {
    ...
    const savedTheme = localStorage.getItem("qoe-theme")
  ...
  const updatePreference = (key: string, value: string, setter: any) => {
      ...
      {isOpen && (
        <div className="absolute top-12 right-0 w-64 p-4 bg-popover border shadow-xl rounded-2xl flex flex-col gap-6 origin-top-right animate-in fade-in zoom-in duration-200">
          ...
          <div className="space-y-3">
            <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Text Size</label>
