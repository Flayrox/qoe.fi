...
export const Card = ({ children, className, variant = "default" }: CardProps) => {
  const variants = {
    ...
    cursor: "relative overflow-hidden bg-card border border-border/30 hover:border-primary/30 hover:shadow-[0_0_20px_rgba(0,0,0,0.05)] dark:hover:shadow-[0_0_20px_rgba(255,255,255,0.03)] transition-all duration-500",
  };
