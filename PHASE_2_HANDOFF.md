...
- Created [`RealtimeFeedPill.tsx`](file:///d:/Files/DEV/Main/qoe.fi/apps/feed/src/components/feed/RealtimeFeedPill.tsx) (floating pill *"X nouvelles pensées ↑"* with smooth scroll and flush trigger).
